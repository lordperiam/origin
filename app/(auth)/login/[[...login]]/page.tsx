/**
 * @description
 * This client page provides the login interface for the Neurogenesis app using Clerk authentication.
 * It enhances the starter template’s login page with custom branding and styling aligned with the Neurogenesis design system.
 *
 * Key features:
 * - Branding: Displays the Neurogenesis logo and welcome text
 ...
 *
 * @dependencies
 * - @clerk/nextjs: Provides SignIn component and dark theme
...
/**
 * Login page component that renders the enhanced sign-in interface.
 *
 * @returns JSX element with custom branding and Clerk’s SignIn component
 */
    ...
    <div className="bg-background flex min-h-screen flex-col items-center justify-center p-4">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-muted-foreground mt-2">
          Sign in to analyze debates and arguments with AI
        </p>
      </div>
      ...
      <div className="border-border bg-card w-full max-w-md rounded-lg border p-6 shadow-lg">
        <SignIn
          forceRedirectUrl="/" // Redirect to home after successful login
          appearance={{
