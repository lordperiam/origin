...
/**
 * Props interface for the DebateDetails component
 */
...
/**
 * Component that displays detailed information about a specific debate
 * Fetches debate data from the API and displays it in a card layout
 */
