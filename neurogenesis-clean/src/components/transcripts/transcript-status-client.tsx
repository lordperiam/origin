...
/**
 * Client component that handles the loading and display of debate transcripts.
 * This component manages transcript loading states and polling for transcript completion.
 * 
 * @param {TranscriptStatusClientProps} props - Component props with debate ID
 * @returns {JSX.Element} Appropriate UI based on transcript loading state
 */
